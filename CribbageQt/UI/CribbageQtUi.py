...
"background-color: rgb(255, 255, 255);")
        ...
        Master.setTabOrder(self.firstNameEntry, self.lastNameEntry)
        Master.setTabOrder(self.lastNameEntry, self.streetEntry)
        Master.setTabOrder(self.streetEntry, self.cityEntry)
        Master.setTabOrder(self.cityEntry, self.stateEntry)
        Master.setTabOrder(self.stateEntry, self.zipEntry)
        Master.setTabOrder(self.zipEntry, self.phoneEntry)
        Master.setTabOrder(self.phoneEntry, self.emailEntry)
        Master.setTabOrder(self.emailEntry, self.accNumberEntry)
        Master.setTabOrder(self.accNumberEntry, self.expiresEntry)
        Master.setTabOrder(self.expiresEntry, self.joinedEntry)
        Master.setTabOrder(self.joinedEntry, self.activeEntry)
        Master.setTabOrder(self.activeEntry, self.playerList)
        Master.setTabOrder(self.playerList, self.showAllPlayers)
        Master.setTabOrder(self.showAllPlayers, self.listOfResultGw)
        Master.setTabOrder(self.listOfResultGw, self.newTourneyDateEntry)
        Master.setTabOrder(self.newTourneyDateEntry, self.listOfPoints)
        Master.setTabOrder(self.listOfPoints, self.listOfTourneys)
        Master.setTabOrder(self.listOfTourneys, self.newTourneyNumberEntry)
        Master.setTabOrder(self.newTourneyNumberEntry, self.listWidget_2)
        Master.setTabOrder(self.listWidget_2, self.listOfResulsNames)
        Master.setTabOrder(self.listOfResulsNames, self.tabWidget)
        Master.setTabOrder(self.tabWidget, self.listOfResultsGp)
        Master.setTabOrder(self.listOfResultsGp, self.listOfResultsSprd)
        Master.setTabOrder(self.listOfResultsSprd, self.listOfResultsTkn)
        Master.setTabOrder(self.listOfResultsTkn, self.listOfResultsCash)
        Master.setTabOrder(self.listOfResultsCash, self.listOfResultsGvn)
        Master.setTabOrder(self.listOfResultsGvn, self.listOfResultsOrder)
        Master.setTabOrder(self.listOfResultsOrder, self.resultLinePlayerGp)
        Master.setTabOrder(self.resultLinePlayerGp, self.resultLinePlayerGw)
        Master.setTabOrder(self.resultLinePlayerGw, self.resultLinePlayerTkn)
        Master.setTabOrder(self.resultLinePlayerTkn, self.resultLinePlayerCash)
        Master.setTabOrder(self.resultLinePlayerCash, self.resultLinePlayerSprd)
        Master.setTabOrder(self.resultLinePlayerSprd, self.listOfReportTourneys)
        Master.setTabOrder(self.listOfReportTourneys, self.allReportsCKB)
        Master.setTabOrder(self.allReportsCKB, self.alphaCKB)
        Master.setTabOrder(self.alphaCKB, self.battingAverageCKB)
        Master.setTabOrder(self.battingAverageCKB, self.cashCKB)
        Master.setTabOrder(self.cashCKB, self.individStatsCKB)
        Master.setTabOrder(self.individStatsCKB, self.nationalAvgesCKB)
        Master.setTabOrder(self.nationalAvgesCKB, self.qtrDropCKB)
        Master.setTabOrder(self.qtrDropCKB, self.qtrFullCKB)
        Master.setTabOrder(self.qtrFullCKB, self.skunkCKB)
        Master.setTabOrder(self.skunkCKB, self.tourneyCKB)
        Master.setTabOrder(self.tourneyCKB, self.runReportsButton)
    ...
    def retranslateUi(self, Master):
        ...
        self.nationalAvgesCKB.setText(_translate("Master", "National Avges Reports"))
