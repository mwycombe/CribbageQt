...
"color: rgb(65, 161, 5);")
        ...
        self.tourneyNumberEntry = QtWidgets.QLineEdit(parent=self.NewTourneyPanel)
        self.tourneyNumberEntry.setGeometry(QtCore.QRect(180, 30, 51, 26))
        self.tourneyNumberEntry.setObjectName("tourneyNumberEntry")
        self.tourneyDateEntry = QtWidgets.QLineEdit(parent=self.NewTourneyPanel)
        self.tourneyDateEntry.setGeometry(QtCore.QRect(180, 60, 141, 26))
        self.tourneyDateEntry.setObjectName("tourneyDateEntry")
...
"background-color: rgb(255, 255, 255);")
        ...
        MainCribbageWindow.setTabOrder(self.activeEntry, self.tourneyNumberEntry)
        MainCribbageWindow.setTabOrder(self.tourneyNumberEntry, self.tourneyDateEntry)
        MainCribbageWindow.setTabOrder(self.tourneyDateEntry, self.listOfTourneys)
