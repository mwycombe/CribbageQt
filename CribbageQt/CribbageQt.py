...
"background-color: rgb(255, 255, 255);")
        ...
        self.newPlayerLabel.setGeometry(QtCore.QRect(100, 10, 91, 20))
...
"background-color: rgb(255, 255, 255);")
        ...
        MainCribbageWindow.setTabOrder(self.activeEntry, self.listOfPlayers)
        MainCribbageWindow.setTabOrder(self.listOfPlayers, self.showAllPlayers)
        MainCribbageWindow.setTabOrder(self.showAllPlayers, self.listOfResultsGw)
        MainCribbageWindow.setTabOrder(self.listOfResultsGw, self.newTourneyDateEntry)
        MainCribbageWindow.setTabOrder(self.newTourneyDateEntry, self.listOfPlayerPoints)
        MainCribbageWindow.setTabOrder(self.listOfPlayerPoints, self.listOfTourneys)
        MainCribbageWindow.setTabOrder(self.listOfTourneys, self.newTourneyNumberEntry)
        MainCribbageWindow.setTabOrder(self.newTourneyNumberEntry, self.listOfResultPlayers)
        MainCribbageWindow.setTabOrder(self.listOfResultPlayers, self.listOfResultsNames)
        MainCribbageWindow.setTabOrder(self.listOfResultsNames, self.tabWidget)
        MainCribbageWindow.setTabOrder(self.tabWidget, self.listOfResultsGp)
        MainCribbageWindow.setTabOrder(self.listOfResultsGp, self.listOfResultsSprd)
        MainCribbageWindow.setTabOrder(self.listOfResultsSprd, self.listOfResultsTkn)
        MainCribbageWindow.setTabOrder(self.listOfResultsTkn, self.listOfResultsCash)
        MainCribbageWindow.setTabOrder(self.listOfResultsCash, self.listOfResultsGvn)
        MainCribbageWindow.setTabOrder(self.listOfResultsGvn, self.listOfResultsOrder)
        MainCribbageWindow.setTabOrder(self.listOfResultsOrder, self.resultLinePlayerGp)
        MainCribbageWindow.setTabOrder(self.resultLinePlayerGp, self.resultLinePlayerGw)
        MainCribbageWindow.setTabOrder(self.resultLinePlayerGw, self.resultLinePlayerTkn)
        MainCribbageWindow.setTabOrder(self.resultLinePlayerTkn, self.resultLinePlayerCash)
        MainCribbageWindow.setTabOrder(self.resultLinePlayerCash, self.resultLinePlayerSprd)
        MainCribbageWindow.setTabOrder(self.resultLinePlayerSprd, self.listOfReportTourneys)
        MainCribbageWindow.setTabOrder(self.listOfReportTourneys, self.allReportsCKB)
        ...
        MainCribbageWindow.setTabOrder(self.qtrDropCKB, self.qtrFullCKB)
        MainCribbageWindow.setTabOrder(self.qtrFullCKB, self.skunkCKB)
    ...
    def retranslateUi(self, MainCribbageWindow):
        ...
        self.label.setText(_translate("MainCribbageWindow", "Existing Players"))
