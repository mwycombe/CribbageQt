# Form implementation generated from reading ui file 'CribbageV1_1_Tourneys_Activity_Test.ui'
#
...
class Ui_TourneysActivity(object):
    def setupUi(self, TourneysActivity):
        TourneysActivity.setObjectName("TourneysActivity")
        TourneysActivity.resize(1114, 612)
        font = QtGui.QFont()
        font.setPointSize(12)
        TourneysActivity.setFont(font)
        self.TopContainer = QtWidgets.QWidget(parent=TourneysActivity)
...
"font: 700 11pt \"Segoe UI\";")
        ...
        self.gridLayoutWidget = QtWidgets.QWidget(parent=self.tourneysActivityPanel)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 0, 731, 171))
        ...
        self.retranslateUi(TourneysActivity)
        QtCore.QMetaObject.connectSlotsByName(TourneysActivity)

    def retranslateUi(self, TourneysActivity):
        _translate = QtCore.QCoreApplication.translate
        TourneysActivity.setWindowTitle(_translate("TourneysActivity", "Cribbage Grass Roots"))
        self.clubNumberLabel.setText(_translate("TourneysActivity", "Club Number:"))
        self.clubNameLabel.setText(_translate("TourneysActivity", "Club Name:"))
        self.clubPlayersLabel.setText(_translate("TourneysActivity", "Players in Club:"))
        self.clubSeasonLabel.setText(_translate("TourneysActivity", "Season:"))
        self.clubNumber.setText(_translate("TourneysActivity", "TextLabel"))
        self.clubName.setText(_translate("TourneysActivity", "TextLabel"))
        self.clubPlayers.setText(_translate("TourneysActivity", "TextLabel"))
        self.clubSeason.setText(_translate("TourneysActivity", "TextLabel"))
        self.playersF1ActivityLabel.setText(_translate("TourneysActivity", "F1    Get help with this activity"))
        self.playersF3ActivityLabel.setText(_translate("TourneysActivity", "F3    Create new tourney"))
        self.playersF2ActivityLabel.setText(_translate("TourneysActivity", "F2    Edit Currently Selected Tourney"))
        self.playersF9ActivityLabel.setText(_translate("TourneysActivity", "F9    Delect selected tourney"))
        self.playersF10ActivityLabel.setText(_translate("TourneysActivity", "F10  Save updates"))
        self.playersEscActivityLabel.setText(_translate("TourneysActivity", "Esc   Quit current activity"))
        self.clubFrameLabel.setText(_translate("TourneysActivity", "Club"))
        self.activityFrameLabel.setText(_translate("TourneysActivity", "Activity"))
        self.SessionFrameLabel.setText(_translate("TourneysActivity", "Session"))
