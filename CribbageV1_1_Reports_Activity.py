# Form implementation generated from reading ui file 'CribbageV1_1_Reports_Activity.ui'
#
...
class Ui_ReportsActivity(object):
    def setupUi(self, ReportsActivity):
        ReportsActivity.setObjectName("ReportsActivity")
        ReportsActivity.resize(1114, 879)
        font = QtGui.QFont()
        font.setPointSize(12)
        ReportsActivity.setFont(font)
        self.TopContainer = QtWidgets.QWidget(parent=ReportsActivity)
...
"font: 700 11pt \"Segoe UI\";")
        ...
        self.retranslateUi(ReportsActivity)
        QtCore.QMetaObject.connectSlotsByName(ReportsActivity)

    def retranslateUi(self, ReportsActivity):
        _translate = QtCore.QCoreApplication.translate
        ReportsActivity.setWindowTitle(_translate("ReportsActivity", "Cribbage Grass Roots"))
        self.clubNumberLabel.setText(_translate("ReportsActivity", "Club Number:"))
        self.clubNameLabel.setText(_translate("ReportsActivity", "Club Name:"))
        self.clubPlayersLabel.setText(_translate("ReportsActivity", "Players in Club:"))
        self.clubSeasonLabel.setText(_translate("ReportsActivity", "Season:"))
        self.clubNumber.setText(_translate("ReportsActivity", "TextLabel"))
        self.clubName.setText(_translate("ReportsActivity", "TextLabel"))
        self.clubPlayers.setText(_translate("ReportsActivity", "TextLabel"))
        self.clubSeason.setText(_translate("ReportsActivity", "TextLabel"))
        self.reportsPickTourneyActivityLabel.setText(_translate("ReportsActivity", "First Pick a Tourney"))
        self.reportsSelectReportsActivityLabel.setText(_translate("ReportsActivity", "Then Select One or More Reports"))
        self.reportsRunReportsActivityLabel.setText(_translate("ReportsActivity", "Then Press Run Reports"))
        self.clubFrameLabel.setText(_translate("ReportsActivity", "Club"))
        self.activityFrameLabel.setText(_translate("ReportsActivity", "Activity"))
        self.SessionFrameLabel.setText(_translate("ReportsActivity", "Session"))
