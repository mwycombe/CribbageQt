# Form implementation generated from reading ui file 'CribbageV1_1_Players_Activity.ui'
#
...
class Ui_PlayersActivity(object):
    def setupUi(self, PlayersActivity):
        PlayersActivity.setObjectName("PlayersActivity")
        PlayersActivity.resize(1115, 879)
        font = QtGui.QFont()
        font.setPointSize(12)
        PlayersActivity.setFont(font)
        self.TopContainer = QtWidgets.QWidget(parent=PlayersActivity)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(150, 20, 141, 132))
...
"font: 700 11pt \"Segoe UI\";")
        ...
        self.retranslateUi(PlayersActivity)
        QtCore.QMetaObject.connectSlotsByName(PlayersActivity)

    def retranslateUi(self, PlayersActivity):
        _translate = QtCore.QCoreApplication.translate
        PlayersActivity.setWindowTitle(_translate("PlayersActivity", "Cribbage Grass Roots"))
        self.clubNumberLabel.setText(_translate("PlayersActivity", "Club Number:"))
        self.clubNameLabel.setText(_translate("PlayersActivity", "Club Name:"))
        self.clubPlayersLabel.setText(_translate("PlayersActivity", "Players in Club:"))
        self.clubSeasonLabel.setText(_translate("PlayersActivity", "Season:"))
        self.clubNumber.setText(_translate("PlayersActivity", "TextLabel"))
        self.clubName.setText(_translate("PlayersActivity", "TextLabel"))
        self.clubPlayers.setText(_translate("PlayersActivity", "TextLabel"))
        self.clubSeason.setText(_translate("PlayersActivity", "TextLabel"))
        self.playersF2ActivityLabel.setText(_translate("PlayersActivity", "F2    Edit player selected in listbox"))
        self.playersF3ActivityLabel.setText(_translate("PlayersActivity", "F3    Create a new player"))
        self.playersDoubleClickActivityLabel.setText(_translate("PlayersActivity", "Double Click entry to toggle active status"))
        self.playersF9ActivityLabel.setText(_translate("PlayersActivity", "F9    Toggle active status for selected player"))
        self.playersF10ActivityLabel.setText(_translate("PlayersActivity", "F10  Save all current changes"))
        self.playersEscActivityLabel.setText(_translate("PlayersActivity", "Esc   Quit current activity"))
        self.clubFrameLabel.setText(_translate("PlayersActivity", "Club"))
        self.activityFrameLabel.setText(_translate("PlayersActivity", "Activity"))
        self.SessionFrameLabel.setText(_translate("PlayersActivity", "Session"))
