...
"background-color: rgb(255, 255, 255);")
        ...
        self.widget = QtWidgets.QWidget(parent=self.newPlayerFrame)
        self.widget.setGeometry(QtCore.QRect(30, 50, 111, 451))
        self.widget.setObjectName("widget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.firstNameLabel = QtWidgets.QLabel(parent=self.widget)
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=self.playerTabPanel)
        self.layoutWidget.setGeometry(QtCore.QRect(570, 130, 152, 461))
...
"background-color: rgb(255, 255, 255);")
        ...
        MainCribbageWindow.setTabOrder(self.activeEntry, self.playerList)
        MainCribbageWindow.setTabOrder(self.playerList, self.showAllPlayers)
        MainCribbageWindow.setTabOrder(self.showAllPlayers, self.listOfResultGw)
        MainCribbageWindow.setTabOrder(self.listOfResultGw, self.newTourneyDateEntry)
        MainCribbageWindow.setTabOrder(self.newTourneyDateEntry, self.listOfPoints)
        MainCribbageWindow.setTabOrder(self.listOfPoints, self.listOfTourneys)
        MainCribbageWindow.setTabOrder(self.listOfTourneys, self.newTourneyNumberEntry)
        MainCribbageWindow.setTabOrder(self.newTourneyNumberEntry, self.listWidget_2)
        MainCribbageWindow.setTabOrder(self.listWidget_2, self.listOfResulsNames)
        MainCribbageWindow.setTabOrder(self.listOfResulsNames, self.tabWidget)
