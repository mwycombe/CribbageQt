...
class Ui_Master(object):
    def setupUi(self, Master):
        ...
        self.sessionFrame.setGeometry(QtCore.QRect(10, 20, 1091, 201))
        ...
        self.clubFrame.setGeometry(QtCore.QRect(20, 20, 401, 171))
        self.clubFrame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        ...
        self.activityFrame = QtWidgets.QFrame(parent=self.sessionFrame)
        self.activityFrame.setGeometry(QtCore.QRect(430, 20, 651, 171))
        self.activityFrame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.activityFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.activityFrame.setLineWidth(2)
        self.activityFrame.setObjectName("activityFrame")
        ...
        self.activityFrameLabel.setGeometry(QtCore.QRect(440, 10, 63, 20))
        ...
        self.playersTab.setGeometry(QtCore.QRect(0, 220, 1101, 691))
        ...
        self.playerTabPanel.setGeometry(QtCore.QRect(0, 0, 1081, 651))
        ...
        self.TourneysFrame.setGeometry(QtCore.QRect(0, 10, 1031, 631))
        ...
        self.TourneysFrame.setLineWidth(3)
...
"color: rgb(65, 161, 5);")
        ...
        self.resultsPanel.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.resultsPanel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.reportsTabPanel.setAutoFillBackground(True)
